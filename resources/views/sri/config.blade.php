        ...
        <div class="max-w-5xl mx-auto px-4 lg:px-6">
            ...
            @if ($errors->any())
                <div class="mb-4 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-red-800">
                    <div class="font-semibold mb-1">Revisa estos errores:</div>
                ...
                <form method="POST" action="{{ route('sri.config.store') }}" enctype="multipart/form-data" class="mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="file" name="certificado_p12"
                            ...
                            @if(!$clear)
                                <div class="text-xs text-slate-500 mt-2">
                                    @if(!empty($config?->ruta_certificado))
                                        Certificado actual:
                                        <code class="px-1 rounded bg-slate-100">{{ $config->ruta_certificado }}</code>
                                    @else
                                        No hay certificado guardado todavía.
                                    @endif
                                </div>
                            @endif
                        </div>
