    ...
    */
    ...
    public function store(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            // ✅ antes era required, ahora NO: el backend recalcula por product_prices
            'items.*.precio_unitario' => 'nullable|numeric|min:0',

            // descuento es MONTO ($), no %
            'items.*.descuento'       => 'nullable|numeric|min:0',

            // opcional: si lo mandas desde UI, ok, pero backend usará IVA del producto
