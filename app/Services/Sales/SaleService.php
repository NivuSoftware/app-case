...
class SaleService
{
    ...
    foreach ($items as $idx => &$item) {
        ...
        // Total SIN IVA (base imponible por línea)
    ...
    try {
        ...
        // La venta NO debe fallar por el SRI
